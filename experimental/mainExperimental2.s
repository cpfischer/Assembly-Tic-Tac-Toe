...
xWinEnd:		jal		printBoard
				la		$a0, UWIN		# prints "You are the winner!"
				li		$v0, 4
				syscall	
				j		endGame

oWinEnd:		jal		printBoard	
				la		$a0, IWIN		# prints "I am the winner!"
				li		$v0, 4
				syscall	
				j		endGame
				
tieEnd:			jal		printBoard
				la		$a0, SCRATCH	# prints "We have a draw!"
				li		$v0, 4
				syscall
